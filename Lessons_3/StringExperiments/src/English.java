public class English {
    String text = "Most people would agree that it is great to have a pet. They are our friends, companions, family members. I have an adorable calico cat as a pet, her name is Minnie. She is two years old, we adopted her when she was just a tiny kitten.\n" +
            ...
            "\n" +
            "As most cats do, Minnie sleeps a lot during the day. We got her a cat house for her Birthday, but she prefers to sleep on my keyboard, on my father’s desk when he is working, on my mom’s lap when she is watching TV. Although, I saw her a few time sleeping in her house.\n" +
            "\n" +
    ...
    public void getTextToWords() {
        ...
        for (int i = 0; i < word.length; i++) {
                    count++;
                    System.out.println("Ñëîâî: " + word[i]);
                }
